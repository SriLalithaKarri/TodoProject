...
function createAndAppendInputEl(todo){
    ...
    console.log('val', prioritySelectEl.value)
    ...
    saveBtn.onclick = () => {
        ...
        todoEl.innerHTML = ""
        // taskPriority.value = prioritySelectEl.value
        // taskCategory.value = ctgrySelectEl.value
        let editedTask = 
            {   
                id:todo.id,
                task:textEl.value,
...
//render tasks that has to complete
